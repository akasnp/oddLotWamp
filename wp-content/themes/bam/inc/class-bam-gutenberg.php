    ...
    class Bam_Gutenberg {
        ...
        public function elements() {
            return array(
                ...
                'headings'  => array(
                    'title'     => esc_html__( 'All Headings', 'bam-pro' ),
                ...
                'h1'  => array(
                    'title'     => esc_html__( 'Heading 1 (h1)', 'bam-pro' ),
                ...
                'h2'  => array(
                    'title'     => esc_html__( 'Heading 2 (h2)', 'bam-pro' ),
                ...
                'h3'  => array(
                    'title'     => esc_html__( 'Heading 3 (h3)', 'bam-pro' ),
                ...
                'h4'  => array(
                    'title'     => esc_html__( 'Heading 4 (h4)', 'bam-pro' ),
                ...
                'post_entry_title'  => array(
                    'title'     => esc_html__( 'Single Post Entry Title', 'bam-pro' ),
                ...
                'single_post_body'  => array(
                    'title'     => esc_html__( 'Single Post Content', 'bam-pro' ),
                    'target'    => 'html .editor-styles-wrapper',
                    'defaults'  => array(
                        'font-size'     => array(
                            'desktop'   => '18px'
                ...
                'page_entry_title'  => array(
                    'title'     => esc_html__( 'Page Title', 'bam-pro' ),
